...
export default class WorldScene extends Phaser.Scene {
  ...
  preload() {
    // Map
    this.load.image("world_map", "{% static './game_demo/assets/Asset_Mappa_Gioco.jpeg' %}");

    // NPC assets (immagini singole; evita di mostrare spritesheet interi)
    this.load.image("npc_net", "{% static './game_demo/assets/npc/npc_net.png' %}");
    this.load.image("npc_sec", "{% static './game_demo/assets/npc/npc_sec.png' %}");
    this.load.image("npc_prog", "{% static './game_demo/assets/npc/npc_prog.png' %}");
    this.load.image("npc_db", "{% static './game_demo/assets/npc/npc_db.png' %}");
